			...
			<div id="sidebar" class="nav-collapse">
				...
				<ul class="sidebar-menu">
					...
					<li class="sub-menu"><a href="javascript:;" class=""> <i
						...
						<ul class="sub">
							<li><a class="hanna" onclick="changeIframeUrl('eduUploadExcel')" style="cursor:pointer">교육일괄등록</a></li>
							<li><a class="hanna"<%-- href="<%=application.getContextPath()%>/resources/admin_page_resource/form_validation.html" --%>>교육등록</a></li>
