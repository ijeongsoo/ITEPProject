...
public class RegistEduPullInfo {
	...
	public void setOrigin_reg_file_nm(String origin_reg_file_nm) {
		this.origin_reg_file_nm = origin_reg_file_nm;
	}
	...
	public String getEdu_hour() {
		return edu_hour;
	}
	public void setEdu_hour(String edu_hour) {
