...
public class Edu002rAttach {
	...
	private MultipartFile regAttach;
	private MultipartFile planAttach;


	
	public MultipartFile getRegAttach() {
		return regAttach;
	}
	public void setRegAttach(MultipartFile regAttach) {
		this.regAttach = regAttach;
	}
	public MultipartFile getPlanAttach() {
		return planAttach;
	}
	public void setPlanAttach(MultipartFile planAttach) {
